function Nbits = image_dct_encV2(infile,bitfile,quality)
...
while rIndex<512
    while cIndex<512
        ...
        %%%tempBlock8x8_DCT =  imgDTC_512x512(rIndex:rIndex+7,cIndex:cIndex+7);
        tempBlock8x8_DCT = dct(tempBlock8x8);
        %disp(tempBlock8x8_DCT)
...
%B_min = min(min(imgq_4096x64))
%B_max = max(max(imgq_4096x64))
for rIndex=2:4096
